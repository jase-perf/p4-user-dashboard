...
def test_servers():
    ...
    yield {
        "tokyo-main": {"port": "localhost:1711", "user": "super", "name": "tokyo-main"},
        "osaka-dev": {"port": "localhost:1712", "user": "super", "name": "osaka-dev"},
        "nagoya-art": {"port": "localhost:1713", "user": "super", "name": "nagoya-art"},
    }
    try:
